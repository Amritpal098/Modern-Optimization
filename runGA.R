...
results1 <- runGA(noRuns = 30, problem = "tsp", popSize = 15, pmutation = 0.2)
results2 <- runGA(noRuns = 30, problem = "tsp", popSize = 15, pmutation = 0.5)
results3 <- runGA(noRuns = 30, problem = "tsp", popSize = 15, pmutation = 0.8)